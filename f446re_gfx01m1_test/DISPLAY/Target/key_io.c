...
/** @defgroup STM32F4XX_NUCLEO_KEY STM32F4XX_NUCLEO KEY
  * @brief      This file includes the KEY driver of
  *             STM32F4XX_NUCLEO boards.
  * @{
  */

/** @defgroup STM32F4XX_NUCLEO_KEY_Private_Types Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32F4XX_NUCLEO_KEY_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32F4XX_NUCLEO_KEY_Private_Macros Private Macros
  * @{
  */
...
/** @defgroup STM32F4XX_NUCLEO_KEY_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32F4XX_NUCLEO_KEY_Private_Variables Private Variables
  * @{
  */
...
/** STM32F4XX_NUCLEO_KEY_Private_FunctionPrototypes Private Functions
  */
...
/** @addtogroup STM32F4XX_NUCLEO_KEY_Exported_Functions
  * @{
  */
/**
...
/** @defgroup STM32F4XX_NUCLEO_KEY_Private_Functions Private Functions
  * @{
  */
