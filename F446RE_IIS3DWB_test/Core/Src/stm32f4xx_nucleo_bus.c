...
/**
  **********************************************************************************
  * This include is not MCD rule compliant.
  * It is necessary for config SPI connectivity:
  * - Mode 1 when DIL24 socket use I2C connectivity (recommended for bluetooth)
  * - Mode 3 when DIL24 socket use SPI connectivity (not recommended for bluetooth)
  **********************************************************************************
*/
...
int32_t BSP_SPI1_Send(uint8_t *pData, uint16_t Length)
{
  ...
  if(HAL_SPI_Transmit(&hspi1, pData, Length, 0x1000u /*BUS_SPI1_POLL_TIMEOUT*/) != HAL_OK)
  {
...
int32_t  BSP_SPI1_Recv(uint8_t *pData, uint16_t Length)
{
  ...
  if(HAL_SPI_Receive(&hspi1, pData, Length, 0x1000u /*BUS_SPI1_POLL_TIMEOUT*/) != HAL_OK)
  {
      ret = BSP_ERROR_UNKNOWN_FAILURE;
  }
  return ret;
