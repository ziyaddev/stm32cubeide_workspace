...
The STM32 H7 Audio Player demonstration is running on STM32H7B3I-DK boards

For more details please refer to the Audio Player subsection in the full demonstration readme.txt file ../readme.txt
...
4- copy the audio files provided under "/Media" in a SD card storage at audio folder
