...
The STM32 H7 ClockAndWeather demonstration is running on STM32H7B3I-DK boards

For more details please refer to the ClockAndWeather subsection in the full demonstration readme.txt file ../readme.txt
...
4- copy the config template provided under "/Media" in a SD card storage at root folder
