...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BUTTON_USER_Pin JOY_CENTER_Pin JOY_LEFT_Pin JOY_DOWN_Pin
                           JOY_RIGHT_Pin JOY_UP_Pin */
  GPIO_InitStruct.Pin = BUTTON_USER_Pin|JOY_CENTER_Pin|JOY_LEFT_Pin|JOY_DOWN_Pin
                          |JOY_RIGHT_Pin|JOY_UP_Pin;
