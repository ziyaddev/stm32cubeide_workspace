...
#else
  /* Set defaul ODR value to 1660Hz for FFT demo */
  #define ACCELERO_ODR_DEFAULT                    1660
...
#define ACCELERO_FIFO_STREAM_MODE       ISM330DLC_STREAM_MODE
#define ACCELERO_FIFO_BYPASS_MODE       ISM330DLC_BYPASS_MODE

/* Complete size for FIFO frame for ism330dlc */
#define FIFO_FRAME_SIZE 3*2
/* Fifo dimension in bytes */
#define MAX_FIFO_SIZE (1024 * 4)
